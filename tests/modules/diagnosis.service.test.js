...
function mockForm(form = MOCK_FORM) {
  const sectionsBySlug = {
    commerce: [
      { key: 'digital_presence', questions: [{ key: 'generates_real_opportunities' }, { key: 'well_positioned' }] },
      { key: 'commercial', questions: [{ key: 'uses_crm' }, { key: 'structured_sales_process' }] },
      { key: 'positioning', questions: [{ key: 'clear_differential' }, { key: 'communication' }] },
      { key: 'growth', questions: [{ key: 'has_growth_goal' }] },
    ],
    industry: [
      { key: 'digital_presence', questions: [{ key: 'marketing_generates_opportunities' }, { key: 'well_positioned_digitally' }] },
      { key: 'commercial', questions: [{ key: 'uses_crm' }, { key: 'structured_sales_process' }] },
      { key: 'positioning', questions: [{ key: 'clear_differential' }] },
    ],
    health: [
      { key: 'digital_presence', questions: [{ key: 'generates_new_patients' }, { key: 'patient_understands_services' }] },
      { key: 'organization_and_relationship', questions: [{ key: 'uses_system' }, { key: 'organized_process' }] },
      { key: 'positioning', questions: [{ key: 'clear_differential' }, { key: 'well_positioned' }] },
    ],
    services: [
      { key: 'digital_presence', questions: [{ key: 'generates_new_clients' }, { key: 'well_positioned' }] },
      { key: 'commercial', questions: [{ key: 'uses_system_or_tool' }, { key: 'structured_process' }] },
      { key: 'positioning', questions: [{ key: 'clear_differential' }] },
    ],
    agro: [
      { key: 'digital_presence', questions: [{ key: 'marketing_generates_opportunities' }, { key: 'client_understands_offer' }, { key: 'well_positioned' }] },
      { key: 'commercial', questions: [{ key: 'uses_crm' }, { key: 'structured_sales_process' }] },
      { key: 'positioning', questions: [{ key: 'clear_differential' }] },
    ],
  };
  return vi.spyOn(formRepo, 'findBySlug').mockResolvedValue({
    ...form,
    sections: form.sections || sectionsBySlug[form.slug] || [],
  });
}
