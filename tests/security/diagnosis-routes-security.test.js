...
describe('diagnosis routes — GET /forms activeOnly guard', () => {
  ...
  it('calls service.listForms(false) when MASTER token passes activeOnly=false', async () => {
    // GET /forms remains public, but optional auth lets admins request inactive forms
    // for the form builder without exposing inactive forms to anonymous callers.
