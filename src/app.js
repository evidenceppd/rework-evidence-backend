...
const blogsCompatRouter = require('./modules/blog/blogs-compat.routes');
...
const siteContentRouter = require('./modules/site-content/site-content.routes');
...
// Public form submissions â€” must be mounted before the requireAuth middleware block
app.use('/api/diagnosis', diagnosisRouter);

// Rate limit para rotas pÃºblicas de leitura (GET sem autenticaÃ§Ã£o).
// Protege o pool de conexÃµes do Prisma contra rajadas de F5 e crawlers.
...
// Mutating cleanup is protected inside analytics.routes.js.
...
app.use('/api/blogs', blogsCompatRouter);
...
app.use((err, req, res, _next) => {
  // Map Prisma validation errors (e.g. invalid UUID format) â†’ 400
