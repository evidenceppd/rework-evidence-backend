...
const { sendNewAnalysisNotification } = require('../../config/mailer');
...
async function submitLead(data) {
  ...
  const score = calculateScore(form, safeData.diagnosis);
  ...
  sendNewAnalysisNotification(lead).catch((err) => {
    console.error(`[ANALISE_EMAIL] Falha ao enviar aviso da análise ${lead.id}: ${err.message}`);
  });
